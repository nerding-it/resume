...
*** Java
Woofers 3D is 3D game API designed to be effortless and simple to use.
Supports modern features such as ray tracing, chasing camera, states and 3D model importing by unifying Bullet, Box2D and OpenGL into open cohesive package.
** Whale
